...
pub const LODVisibilityLevelDisplay = timing_overlay.LODVisibilityLevelDisplay;
pub const LOD_VISIBILITY_LEVEL_COUNT = timing_overlay.LOD_VISIBILITY_LEVEL_COUNT;
