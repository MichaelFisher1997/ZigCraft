const impl = @import("engine-assets-impl");

pub const material_system = impl.material_system;
pub const resource_pack = impl.resource_pack;
pub const texture_atlas = impl.texture_atlas;
