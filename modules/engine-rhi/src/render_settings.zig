...
pub const RENDER_DISTANCE_PRESETS = [_]RenderDistancePresetConfig{
    .{
        .lod_radii = .{ 6, 24, 64, 160, 256 },
        .horizon_radius = 256,
        .lod_store_size_cap_mb = 512,
        .horizontal_detail = .{ 16, 32, 48, 48, 24 },
