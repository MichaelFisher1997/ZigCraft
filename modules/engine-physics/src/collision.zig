...
pub const VoxelCollisionWorld = struct {
    ptr: *anyopaque,
    vtable: *const VTable,

    pub const VTable = struct {
        isSolidAt: *const fn (ptr: *anyopaque, x: i32, y: i32, z: i32) bool,
    };

    pub fn isSolidAt(self: VoxelCollisionWorld, x: i32, y: i32, z: i32) bool {
        return self.vtable.isSolidAt(self.ptr, x, y, z);
    }
};
...
pub fn collidesWithWorld(world: VoxelCollisionWorld, aabb: AABB) bool {
...
pub fn isOnGround(world: VoxelCollisionWorld, aabb: AABB) bool {
...
pub fn getGroundLevel(world: VoxelCollisionWorld, x: f32, z: f32) i32 {
