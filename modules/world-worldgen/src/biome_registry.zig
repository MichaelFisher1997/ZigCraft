...
pub const BIOME_POINTS = [_]BiomePoint{
    ...
    .{ .id = .grove, .heat = 18, .humidity = 65, .weight = 0.7, .min_continental = 0.65, .y_min = 85, .y_max = 130 },
    .{ .id = .snowy_slopes, .heat = 8, .humidity = 45, .weight = 0.7, .min_continental = 0.70, .y_min = 105, .y_max = 155 },
    .{ .id = .frozen_peaks, .heat = 4, .humidity = 35, .weight = 0.5, .min_continental = 0.75, .y_min = 130 },
    ...
    .{ .id = .meadow, .heat = 45, .humidity = 55, .weight = 0.7, .min_continental = 0.65, .y_min = 80, .y_max = 120, .max_slope = 8 },
    .{ .id = .jagged_peaks, .heat = 32, .humidity = 45, .weight = 0.5, .min_continental = 0.75, .y_min = 125 },
    ...
    .{ .id = .stony_peaks, .heat = 65, .humidity = 25, .weight = 0.5, .min_continental = 0.75, .y_min = 120 },
...
pub const BIOME_REGISTRY: []const BiomeDefinition = &.{
    ...
    .{
        ...
        .elevation = .{ .min = 0.48, .max = 0.76 },
        .continentalness = .{ .min = 0.65, .max = 1.0 },
        .ruggedness = .{ .min = 0.35, .max = 0.75 },
        .min_height = 80,
        .max_height = 125,
        .max_slope = 8,
        .priority = 7,
        ...
        .terrain = .{ .height_amplitude = 1.0, .smoothing = 0.25 },
    ...
    .{
        ...
        .humidity = .{ .min = 0.45, .max = 0.95 },
        .elevation = .{ .min = 0.50, .max = 0.82 },
        .continentalness = .{ .min = 0.65, .max = 1.0 },
        .ruggedness = .{ .min = 0.35, .max = 0.85 },
        .min_height = 85,
        .max_height = 135,
        .priority = 8,
        ...
        .terrain = .{ .height_amplitude = 1.15, .smoothing = 0.15 },
    ...
    .{
        ...
        .elevation = .{ .min = 0.62, .max = 0.90 },
        .continentalness = .{ .min = 0.70, .max = 1.0 },
        .ruggedness = .{ .min = 0.45, .max = 0.95 },
        .min_height = 105,
        .max_height = 160,
        .priority = 8,
        .surface = .{ .top = .snow_block, .filler = .stone, .depth_range = 1 },
        ...
        .terrain = .{ .height_amplitude = 1.3, .smoothing = 0.08 },
