...
const shadow_scene = @import("engine-graphics").shadow_scene;
...
const ILPVWorld = @import("engine-graphics").lpv_system.ILPVWorld;
const GpuLight = @import("engine-graphics").lpv_types.GpuLight;
