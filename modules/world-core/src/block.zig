...
pub const Biome = enum(u8) {
    ...
    pub fn getSurfaceBlock(self: Biome) BlockType {
        return switch (self) {
            ...
            .tropical => .sand,
            .beach => .sand,
            .plains, .forest, .swamp, .jungle, .savanna, .foothills, .marsh, .dry_plains, .coastal_plains, .meadow => .grass,
            .taiga => .grass,
            .desert => .sand,
            .snow_tundra, .snowy_mountains, .snowy_slopes => .snow_block,
            .mountains, .jagged_peaks, .stony_peaks => .stone,
            .grove => .podzol,
    ...
    pub fn getFillerBlock(self: Biome) BlockType {
        return switch (self) {
            ...
            .plains, .forest, .taiga, .swamp, .jungle, .savanna, .foothills, .marsh, .dry_plains, .coastal_plains, .meadow, .grove => .dirt,
            .snow_tundra => .dirt,
