...
pub const Biome = enum(u8) {
    ...
    pub fn getSurfaceBlock(self: Biome) BlockType {
        return switch (self) {
            ...
            .tropical => .sand,
            .beach => .sand,
            .plains, .forest, .birch_forest, .dark_forest, .flower_forest, .swamp, .jungle, .savanna, .foothills, .marsh, .dry_plains, .coastal_plains => .grass,
    ...
    pub fn getFillerBlock(self: Biome) BlockType {
        return switch (self) {
            ...
            .plains, .forest, .birch_forest, .dark_forest, .flower_forest, .taiga, .snowy_taiga, .old_growth_taiga, .swamp, .jungle, .savanna, .foothills, .marsh, .dry_plains, .coastal_plains => .dirt,
            .snow_tundra => .dirt,
